...
void
LocalConfigInfoProcessor::saveSnapshot(const NacosString &envName, const NacosString &dataId, const NacosString &group,
...
NacosString LocalConfigInfoProcessor::getFailoverFile(const NacosString &serverName, const NacosString &dataId,
                                                      const NacosString &group, const NacosString &tenant) {
...
NacosString LocalConfigInfoProcessor::getSnapshotFile(const NacosString &envName, const NacosString &dataId,
                                                      const NacosString &group, const NacosString &tenant) {
